...
@section('content')
<ul class="breadcrumb">
  <li><a class="btn btn-outline-primary " href="{{route('viewTotalStudentFollowup')}}">Follow Up</a></li>
  <li><a class="btn btn-outline-primary disabled" href="{{route('viewStudentOutOfFollowup')}}">Out of followUp</a></li>
</ul>
<!-- Main content -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center text-primary">Student Out Of Followup</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="users" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($studentOutOfFollowup as $student)
                                <tr>
                                    <td>{{$student->id}}</td>
                                    ...
                                    <td>
                                        @if($student->status == 2)
                                            <div class="dropdown">
                                                ...
                                                <a href="{{route('followup',$student->id)}}">Back to Followup</a>
                                                </ul>  
                                            </div>
                                        @endif
                                    </td>
